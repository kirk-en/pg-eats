...
const updateData = {
  "293460ab-62dc-4bad-a878-d2cea08f62bf": 10596.436398963288,
  "0ab6eea9-8441-43a1-8ff9-3b9c3f4db05c": 11000,
  "c1e564c4-d180-41ab-a9db-a843e89b7c0d": 1000.8722747752099,
  "a48bc44a-2c67-4d5a-833a-5f1807d6c8a0": 8185.938296884685,
  "32469e4a-1b91-4667-950f-54bcf091f7c5": 6601.712474912629,
  "80a15c6d-01ab-4c1b-952b-46614a4848af": 0.000254522953,
  "9b0878b1-ac48-4c07-a6a0-ceceb7362fa6": 11103.63667185837,
  "b73c61fc-073c-435d-8b63-c78498e68e08": 10002.103534542486,
  "c5f685fb-b513-4332-8bb2-27f595b1ab0c": 10000.0,
  "08dc1697-37e6-4b7d-bd51-1cbbd5031cf4": 11000.182638328912,
  "6e77b153-1ca5-4174-86bb-1db50ff184d8": 1132.791959535122,
  "6287a104-a362-4224-a87e-312da4ea30c3": 0.464184895123,
  "f1b197ba-f637-4b93-8a20-1ff5cf4766b5": 0.0104553790459,
  ...
  "9d075981-85bd-4ede-b7aa-9e4c2ff5df06": 1443.880320068848,
  ...
  "01798f4f-ed45-4516-9d9c-23591f38a8e0": 889.8302484569032,
...
const newUsers = [
  {
    id: "dd09b4a9-7f65-4364-8475-b29cad8db6f8",
    username: "Eamon Davis",
    balance: 10000.0,
  },
  {
    id: "f8a041d4-d726-4325-ab9e-eb48facd7e3b",
    username: "Jillaine Martinez",
    balance: 10000.0,
  },
  {
    id: "9a9a844e-2cb6-4cdb-a8c4-cc0a7f186f64",
    username: "Brittney Dickerson",
    balance: 10000.0,
  },
];
...
try {
  ...
  const currentUsersJson = fs.readFileSync(usersFilePath, "utf8");
  let users = JSON.parse(currentUsersJson);

  // Update balances for existing users
  users = users.map((user) => {
    if (updateData.hasOwnProperty(user.id)) {
      return {
        ...user,
        balance: updateData[user.id],
      };
    }
    return user;
  });
  ...
  console.log(`✓ Updated balances for ${Object.keys(updateData).length} users`);
